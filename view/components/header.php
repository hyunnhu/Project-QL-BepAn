                    ...
                    <div class="navbar-nav ms-auto py-0 pe-4">
                        ...
                        <div class="nav-item dropdown">
                            ...
                            <div class="dropdown-menu m-0">
                                ...
                                <a href="team.html" class="dropdown-item">Drop2</a>
                            </div>
                        </div>
                        <a href="
                        ...
                        <div class="col-lg-6 text-center text-lg-start">
                            ...
                            if (isset($_SESSION["role"])) {
                                switch ($_SESSION["role"]) {
                                    case 1:
                                        echo '<h1 class="display-3 text-white animated slideInLeft">
                                        Chào Mừng<br />Đến Trang Quản lý Của Kitchen Pro++
                                        </h1>';
                                        break;
                                    case 2:
                                        echo '<h1 class="display-3 text-white animated slideInLeft">
                                        Chào Mừng<br />Đến Trang Đầu Bếp Của Kitchen Pro++
                                        </h1>';
                                        break;
                                    case 3:
                                        echo '<h1 class="display-3 text-white animated slideInLeft">
                                        Thưởng Thức Món Ngon<br />Tại Kitchen Pro++
                                        </h1>';
                                        break;
                                    case 4:
                                        echo '<h1 class="display-3 text-white animated slideInLeft">
                                        Chào Mừng<br />Đến Trang Phục Vụ Của Kitchen Pro++
                                        </h1>';
                                        break;
                                }
                            }
